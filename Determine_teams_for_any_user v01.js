...
{  
	...
	{
		window.alert( "function IsAuthorizedForTeams error code " + err  + "\nerr name = " + err.name + "\nerr message = " + err.message );
	}
}
...
function getUserTeams( userid )
{
	...
	{
		window.alert( "function getUserTeams error code " + err + "\nerr name = " + err.name + "\nerr message = " + err.message );
	}
}
...
function gIsArray( obj ) 
{
	...
	{
		window.alert( "function gIsArray error code " + err );
	}
}
...
function gNullToString( strInput )
{
	...
	{
		window.alert( "function gNullToString error code " + err );
	}
}
